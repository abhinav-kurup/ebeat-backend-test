...
# # Optionally, set a custom session key name (default is 'sessionid')
# # SESSION_COOKIE_NAME = 'my_custom_cookie_name'
# SESSION_COOKIE_PATH = '/login/' 
# # Set the age of the session cookies (in seconds)
# # This example sets the session to expire after 1 day (86400 seconds)
